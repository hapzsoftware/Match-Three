...
public class LevelManager : MonoBehaviour
{
    ...
    public void EnableMap(bool enable)
    {
        ...
        if (!enable)
            Camera.main.transform.position = new Vector3(0, 0, -10.70f);
...
//        InitTargets();
    ...
    private void GenerateLevel()
    {
        ...
        Vector3 fieldPos = new Vector3(-maxCols / 2.75f, maxRows / 2.75f,-10.0f);
        for (int row = 0; row < maxRows; row++)
        {
            if (maxCols % 2 == 0)
    ...
    void AnimateField(Vector3 pos)
    {
        ...
        anim.Play("appear");
        GameField.transform.position = new Vector3(pos.x + 15, pos.y + yOffset);

        print("AAAAAAAAAAAAAAAAAA" + GameField.transform.position);
    }
